...
exports.default = $stylesheet.create(
  ...
  "",
  7,
  /*! ./components/Slider/Slider.st.css */ 305
);
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + ".Slider3018899081--root{position: relative;box-sizing: border-box;outline: none}\n" + $id + ".Slider3018899081--root *{box-sizing: border-box}\n" + $id + " .Slider3018899081--tooltip{position: absolute;background: #363636;color: #fff;padding: 4px 12px;text-align: center;font-size: 14px;line-height: 1.5;border-radius: 3px;white-space: nowrap}\n" + $id + " .Slider3018899081--tooltip::after, " + $id + " .Slider3018899081--tooltip::before{content: ' ';position: absolute;margin-left: -8px;border-width: 8px;border-style: solid}\n" + $id + " .Slider3018899081--track{z-index: 0;width: 100%;height: 25%;position: relative;cursor: pointer;background: #dadada;opacity: 1;border-radius: 8px;overflow: hidden;border: 2px solid transparent;min-height: 1px}\n" + $id + " .Slider3018899081--inner{display: flex;position: relative;align-items: center;justify-content: center;width: 100%;height: 100%}\n" + $id + " .Slider3018899081--trackFill{position: absolute;background: linear-gradient(to right,#4992e3,#70bff3);height: 100%;width: 100%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-dir=\"rtl\"] .Slider3018899081--trackFill{right: 0}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--track{width: 25%;height: 100%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--trackFill{background: linear-gradient(to top,#4992e3,#70bff3)}\n" + $id + " .Slider3018899081--thumb{z-index: 2;position: absolute;cursor: pointer}\n" + $id + " .Slider3018899081--thumbShape{width: 100%;height: 100%;background: green;border: 2px solid blue}\n" + $id + " .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"circle\"]{border-radius: 50%}\n" + $id + " .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"square\"]{border-radius: 7px}\n" + $id + " .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"rectangle\"]{border-radius: 37px}\n" + $id + " .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"bar\"]{border-radius: 7px}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]{left: 50%;top: calc(-7px - 10px);transform: translate(-50%,-100%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]{left: 50%;bottom: calc(-7px - 10px);transform: translate(-50%,100%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]{left: 50%;left: calc(-7px - 10px);transform: translate(-100%,-50%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]{right: calc(-7px - 10px);transform: translate(100%,-50%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::after, " + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::before{border-color: #363636 transparent transparent transparent;top: 100%;left: 50%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::after, " + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::before{border-color: transparent transparent #363636 transparent;bottom: 100%;left: 50%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip{top: 50%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip::after, " + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip::before{top: 50%;transform: translateY(-50%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::after, " + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::before{left: 100%;margin-left: 0;border-color: transparent transparent transparent #363636}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::after, " + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::before{right: 100%;border-color: transparent #363636 transparent transparent}\n" + $id + " .Slider3018899081--tick{display: inline-block;position: absolute;background: #000;cursor: pointer}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-tickmarksshape=\"line\"] .Slider3018899081--tick{width: 1px;height: 10px}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"][data-slider3018899081-tickmarksshape=\"line\"] .Slider3018899081--tick{height: 1px;width: 10px}\n" + $id + ".Slider3018899081--root[data-slider3018899081-tickmarksshape=\"dot\"] .Slider3018899081--tick{width: 3px;height: 3px;border-radius: 50%}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-tickmarksshape=\"dot\"] .Slider3018899081--tick{transform: translateX(calc(- 3px,2))}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"][data-slider3018899081-tickmarksshape=\"dot\"] .Slider3018899081--tick{transform: translateY(calc(3px,2))}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-tickmarksposition=\"normal\"] .Slider3018899081--tick{bottom: 0}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"][data-slider3018899081-tickmarksposition=\"normal\"] .Slider3018899081--tick{right: 0}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-tickmarksposition=\"middle\"] .Slider3018899081--tick{top: 50%;transform: translateY(-50%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"][data-slider3018899081-tickmarksposition=\"middle\"] .Slider3018899081--tick{left: 50%;transform: translateX(-50%)}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-tickmarksposition=\"across\"] .Slider3018899081--tick{top: 0}\n" + $id + ".Slider3018899081--root[data-slider3018899081-orientation=\"vertical\"][data-slider3018899081-tickmarksposition=\"across\"] .Slider3018899081--tick{left: 0}\n" + $id + ".Slider3155612545--root{z-index: 0}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape{background: " + $params["thumbBackground"] + ";border-color: " + $params["thumbBorderColor"] + ";border-width: " + $params["thumbBorderWidth"] + ";box-shadow: " + $params["thumbBoxShadow"] + ";border-style: solid}\n" + $id + ".Slider3155612545--root .Slider3018899081--tick{background: " + $params["tickMarkColor"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--tooltip{font-family: " + $params["tooltipFontFamily"] + ";font-size: " + $params["tooltipFontSize"] + ";color: " + $params["tooltipFontColor"] + ";background: " + $params["tooltipBackground"] + ";border-width: 0;border-radius: " + $params["tooltipBorderRadius"] + ";box-shadow: " + $params["tooltipBoxShadow"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--tooltip::before{border-width: 0}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::after{border-color: " + $params["tooltipBackground"] + " transparent transparent transparent}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"horizontal\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::after{border-color: transparent transparent " + $params["tooltipBackground"] + " transparent}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-normalposition]::after{border-color: transparent transparent transparent " + $params["tooltipBackground"] + "}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--tooltip[data-slider3018899081-acrossposition]::after{border-color: transparent " + $params["tooltipBackground"] + " transparent transparent}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-hover] .Slider3018899081--thumbShape, " + $id + ".Slider3155612545--root:hover .Slider3018899081--thumbShape{background: " + $params["thumbBackgroundHover"] + ";border-color: " + $params["thumbBorderColorHover"] + ";border-width: " + $params["thumbBorderWidthHover"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-focus] .Slider3018899081--thumbShape, " + $id + ".Slider3155612545--root:focus .Slider3018899081--thumbShape{background: " + $params["thumbBackgroundFocus"] + ";border-color: " + $params["thumbBorderColorFocus"] + ";border-width: " + $params["thumbBorderWidthFocus"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-disabled] .Slider3018899081--thumbShape, " + $id + ".Slider3155612545--root[data-slider3018899081-disabled] .Slider3018899081--thumbShape{background: " + $params["thumbBackgroundDisabled"] + ";border-color: " + $params["thumbBorderColorDisabled"] + ";border-width: " + $params["thumbBorderWidthDisabled"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--track{background: " + $params["trackBackground"] + ";border-radius: " + $params["trackBorderRadius"] + ";border-color: " + $params["trackBorderColor"] + ";border-width: " + $params["trackBorderWidth"] + ";box-shadow: " + $params["trackBoxShadow"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--trackFill{background: " + $params["trackFill"] + ";border-radius: " + $params["trackBorderRadius"] + "}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-dir=\"ltr\"] .Slider3018899081--trackFill{border-top-left-radius: 0;border-bottom-left-radius: 0}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"horizontal\"][data-slider3018899081-dir=\"rtl\"] .Slider3018899081--trackFill{border-top-right-radius: 0;border-bottom-right-radius: 0}\n" + $id + ".Slider3155612545--root[data-slider3018899081-orientation=\"vertical\"] .Slider3018899081--trackFill{border-bottom-right-radius: 0;border-bottom-left-radius: 0}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-hover] .Slider3018899081--trackFill, " + $id + ".Slider3155612545--root:hover .Slider3018899081--trackFill{background: " + $params["trackFillHover"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-focus] .Slider3018899081--trackFill, " + $id + ".Slider3155612545--root:focus .Slider3018899081--trackFill{background: " + $params["trackFillFocus"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-disabled] .Slider3018899081--trackFill, " + $id + ".Slider3155612545--root[data-slider3018899081-disabled] .Slider3018899081--trackFill{background: " + $params["trackFillDisabled"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-hover] .Slider3018899081--track, " + $id + ".Slider3155612545--root:hover .Slider3018899081--track{background: " + $params["trackBackgroundHover"] + ";border-color: " + $params["trackBorderColorHover"] + ";border-width: " + $params["trackBorderWidthHover"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-focus] .Slider3018899081--track, " + $id + ".Slider3155612545--root:focus .Slider3018899081--track{background: " + $params["trackBackgroundFocus"] + ";border-color: " + $params["trackBorderColorFocus"] + ";border-width: " + $params["trackBorderWidthFocus"] + "}\n" + $id + ".Slider3155612545--root[data-slider3155612545-preview-disabled] .Slider3018899081--track, " + $id + ".Slider3155612545--root[data-slider3018899081-disabled] .Slider3018899081--track{background: " + $params["trackBackgroundDisabled"] + ";border-color: " + $params["trackBorderColorDisabled"] + ";border-width: " + $params["trackBorderWidthDisabled"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"circle\"]{border-radius: 50%}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"circle\"][data-slider3018899081-shapetype=\"circle\"]{border-radius: " + $params["thumbBorderRadius"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"square\"]{border-radius: 17px}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"square\"][data-slider3018899081-shapetype=\"square\"]{border-radius: " + $params["thumbBorderRadius"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"rectangle\"]{border-radius: 37px}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"rectangle\"][data-slider3018899081-shapetype=\"rectangle\"]{border-radius: " + $params["thumbBorderRadius"] + "}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"bar\"]{border-radius: 5px}\n" + $id + ".Slider3155612545--root .Slider3018899081--thumbShape[data-slider3018899081-shapetype=\"bar\"][data-slider3018899081-shapetype=\"bar\"]{border-radius: " + $params["thumbBorderRadius"] + "}\n";
};
...
var _Slider = __webpack_require__(/*! ./Slider */ 571);

var _SliderSt = __webpack_require__(/*! ./Slider.st.css */ 305);
...
exports.default = $stylesheet.create(
  "root",
  "Slider3018899081",
  {"root":"Slider3018899081--root","tooltip":"Slider3018899081--tooltip","track":"Slider3018899081--track","inner":"Slider3018899081--inner","trackFill":"Slider3018899081--trackFill","thumb":"Slider3018899081--thumb","thumbShape":"Slider3018899081--thumbShape","tick":"Slider3018899081--tick","tickLineWidth":"1px","tickLineHeight":"10px","tickDotSize":"3px","tickMarksGap":"12px","tooltipGap":"10px"},
  "",
  1,
  /*! ../node_modules/wix-ui-core/dist/src/components/Slider/Slider.st.css */ 45
);
...
var _Slider = __webpack_require__(/*! wix-ui-core/dist/src/components/Slider/Slider */ 572);
...
var React = __webpack_require__(/*! react */ 0);
var Ticks_1 = __webpack_require__(/*! ./Ticks */ 573);
var Thumb_1 = __webpack_require__(/*! ./Thumb */ 574);
var Slider_st_css_1 = __webpack_require__(/*! ./Slider.st.css */ 45);
var noop = __webpack_require__(/*! lodash/noop */ 575);
