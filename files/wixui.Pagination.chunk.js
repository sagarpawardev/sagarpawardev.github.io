...
exports.default = $stylesheet.create(
  "root",
  "Pagination1468839169",
  {"button-common-mixin":"Pagination1468839169--button-common-mixin","root":"Pagination1468839169--root","navButton":"Pagination1468839169--navButton","disabled":"Pagination1468839169--disabled","navButtonFirst":"Pagination1468839169--navButtonFirst","navButtonPrevious":"Pagination1468839169--navButtonPrevious","navButtonNext":"Pagination1468839169--navButtonNext","navButtonLast":"Pagination1468839169--navButtonLast","pageStrip":"Pagination1468839169--pageStrip","pageStripInner":"Pagination1468839169--pageStripInner","pageStripTemplate":"Pagination1468839169--pageStripTemplate","pageButton":"Pagination1468839169--pageButton","currentPage":"Pagination1468839169--currentPage","gap":"Pagination1468839169--gap","pageForm":"Pagination1468839169--pageForm","pageInput":"Pagination1468839169--pageInput","totalPages":"Pagination1468839169--totalPages","slash":"Pagination1468839169--slash"},
  "",
  1,
  /*! ../node_modules/wix-ui-core/dist/src/components/Pagination/Pagination.st.css */ 26
);
...
var PageStrip_1 = __webpack_require__(/*! ./PageStrip */ 564);
var Pagination_st_css_1 = __webpack_require__(/*! ./Pagination.st.css */ 26);
var root_min_width_1 = __webpack_require__(/*! ./root-min-width */ 566);
...
exports.default = $stylesheet.create(
  ...
  "",
  7,
  /*! ./components/Pagination/Pagination.st.css */ 303
);
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + " .Pagination1468839169--button-common-mixin{display: inline-flex;flex-shrink: 0}\n" + $id + ".Pagination1468839169--root{display: inline-flex;user-select: none}\n" + $id + " .Pagination1468839169--navButton{display: inline-flex;flex-shrink: 0}\n" + $id + " .Pagination1468839169--navButton:not(.Pagination1468839169--disabled){cursor: pointer}\n" + $id + " .Pagination1468839169--navButtonFirst{order: 1}\n" + $id + " .Pagination1468839169--navButtonPrevious{order: 2}\n" + $id + " .Pagination1468839169--navButtonNext{order: 4}\n" + $id + " .Pagination1468839169--navButtonLast{order: 5}\n" + $id + " .Pagination1468839169--pageStrip{order: 3;overflow-x: hidden}\n" + $id + " .Pagination1468839169--pageStripInner{display: flex}\n" + $id + " .Pagination1468839169--pageStripTemplate{height: 0;overflow: hidden}\n" + $id + " .Pagination1468839169--pageButton{display: inline-flex;flex-shrink: 0;cursor: pointer}\n" + $id + " .Pagination1468839169--currentPage{display: inline-flex;flex-shrink: 0}\n" + $id + " .Pagination1468839169--gap{display: inline-flex;flex-shrink: 0}\n" + $id + " .Pagination1468839169--pageForm{display: flex;order: 3}\n" + $id + " .Pagination1468839169--pageInput{}\n" + $id + " .Pagination1468839169--totalPages{}\n" + $id + " .Pagination1468839169--slash{}\n" + $id + " .Pagination1096990051--pageButtonRules{min-width: 1em;min-height: 1em;line-height: 1em;justify-content: center;align-items: center;padding: 0.5em 0.5em;margin: 0.25em}\n" + $id + ".Pagination1096990051--root{align-items: stretch;font: " + $params["fnt"] + ";box-sizing: border-box}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageButton{min-width: 1em;min-height: 1em;line-height: 1em;justify-content: center;align-items: center;padding: 0.5em 0.5em;margin: 0.25em;position: relative;color: " + $params["pageNumbersTextColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--currentPage{min-width: 1em;min-height: 1em;line-height: 1em;justify-content: center;align-items: center;padding: 0.5em 0.5em;margin: 0.25em;color: " + $params["selectedPageTextColor"] + ";background: " + $params["selectedPageBG"] + ";border-radius: " + $params["bRadius"] + ";border: " + $params["selectedPageBorderWidth"] + " solid " + $params["selectedPageBorderColor"] + ";box-shadow: " + $params["shadow"] + ";padding: calc(0.5em - " + $params["selectedPageBorderWidth"] + ") calc(0.5em - " + $params["selectedPageBorderWidth"] + ")}\n" + $id + ".Pagination1096990051--root:not([data-pagination1468839169-disabled]) .Pagination1468839169--pageButton:hover::before{background: " + $params["selectedPageBG"] + ";opacity: 0.2;content: \"\";position: absolute;top: 0;right: 0;bottom: 0;left: 0;border-radius: " + $params["bRadius"] + "}\n" + $id + ".Pagination1096990051--root:not([data-pagination1468839169-disabled]) .Pagination1468839169--pageButton:hover{opacity: 0.7}\n" + $id + ".Pagination1096990051--root[data-pagination1468839169-disabled] .Pagination1468839169--pageButton{cursor: default}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton{min-width: 1em;min-height: 1em;padding: calc(0.75em - " + $params["navButtonBorderWidth"] + ");display: flex;justify-content: center;align-items: center;border: " + $params["navButtonBorderWidth"] + " solid " + $params["navButtonBorderColor"] + ";background: " + $params["navButtonBG"] + ";border-radius: " + $params["bRadius"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton[data-pagination1468839169-disabled], " + $id + ".Pagination1096990051--root[data-preview=\"disabled\"] .Pagination1468839169--navButton{padding: calc(0.75em - " + $params["navButtonDisabledBorderWidth"] + ");border: " + $params["navButtonDisabledBorderWidth"] + " solid " + $params["navButtonDisabledBorderColor"] + ";background: " + $params["navButtonDisabledBG"] + ";cursor: default}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton[data-pagination1468839169-disabled] svg, " + $id + ".Pagination1096990051--root[data-preview=\"disabled\"] .Pagination1468839169--navButton svg{fill: " + $params["arrowsDisabledColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton:hover:not([data-pagination1468839169-disabled]){opacity: 0.8}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton svg{width: 1em;min-width: 16px;height: 1em;min-height: 16px;fill: " + $params["arrowsColor"] + "}\n" + $id + ".Pagination1096990051--root[dir=\"rtl\"] .Pagination1468839169--navButton svg{transform: scaleX(-1)}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton span{font-size: " + $params["navButtonTextSize"] + ";color: " + $params["navButtonTextColor"] + ";line-height: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButton[data-pagination1468839169-disabled] span, " + $id + ".Pagination1096990051--root[data-preview=\"disabled\"] .Pagination1468839169--navButton span{color: " + $params["navButtonDisabledTextColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButtonFirst{margin-right: 1em}\n" + $id + ".Pagination1096990051--root[dir=\"rtl\"] .Pagination1468839169--navButtonFirst{margin-right: 0;margin-left: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButtonPrevious{margin-right: 1em}\n" + $id + ".Pagination1096990051--root[dir=\"rtl\"] .Pagination1468839169--navButtonPrevious{margin-right: 0;margin-left: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButtonLast{margin-left: 1em}\n" + $id + ".Pagination1096990051--root[dir=\"rtl\"] .Pagination1468839169--navButtonLast{margin-left: 0;margin-right: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--navButtonNext{margin-left: 1em}\n" + $id + ".Pagination1096990051--root[dir=\"rtl\"] .Pagination1468839169--navButtonNext{margin-left: 0;margin-right: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--gap{min-width: 1em;min-height: 1em;line-height: 1em;justify-content: center;align-items: center;padding: 0.5em 0.5em;margin: 0.25em;color: " + $params["pageNumbersTextColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageStrip{min-width: 3em;overflow: visible;align-self: center}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageStripInner{flex-grow: 1;flex-basis: auto;justify-content: center;overflow: visible;align-items: center}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageStripTemplate{overflow: hidden}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageForm{flex-grow: 1;flex-basis: auto;justify-content: center;align-items: stretch}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--slash{width: 1em;height: 1em;flex-shrink: 0;align-self: center}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--slash svg{width: 1em;height: 1em}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--slash svg > g{stroke: " + $params["totalPagesTextColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageInput{min-width: 3.5em;padding: calc(0.25em - " + $params["pageInputBorderWidth"] + ") calc(0.5ch - " + $params["pageInputBorderWidth"] + ");color: " + $params["pageInputTextColor"] + ";border-radius: " + $params["bRadius"] + ";border: " + $params["pageInputBorderWidth"] + " solid " + $params["pageInputBorderColor"] + ";text-align: center;margin: 0 0.25em;background: " + $params["pageInputBG"] + ";box-shadow: " + $params["shadow"] + ";font: inherit;-moz-appearance: textfield}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageInput:hover{opacity: 0.8}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageInput:focus, " + $id + ".Pagination1096990051--root[data-preview=\"focus\"] .Pagination1468839169--pageInput{padding: calc(0.25em - " + $params["pageInputFocusBorderWidth"] + ") calc(0.5ch - " + $params["pageInputFocusBorderWidth"] + ");background: " + $params["pageInputFocusBG"] + ";border: " + $params["pageInputFocusBorderWidth"] + " solid " + $params["pageInputFocusBorderColor"] + "}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--pageInput::-webkit-inner-spin-button, " + $id + ".Pagination1096990051--root .Pagination1468839169--pageInput::-webkit-outer-spin-button{-webkit-appearance: none}\n" + $id + ".Pagination1096990051--root .Pagination1468839169--totalPages{max-width: 4ch;min-width: 1ch;padding-left: 0.25em;overflow: hidden;text-overflow: ellipsis;color: " + $params["totalPagesTextColor"] + ";align-self: center}\n" + $id + ".Pagination1096990051--root[data-pagination1468839169-error] .Pagination1468839169--pageInput, " + $id + ".Pagination1096990051--root[data-preview=\"error\"] .Pagination1468839169--pageInput{padding: calc(0.25em - " + $params["pageInputErrorBorderWidth"] + ") calc(0.5ch - " + $params["pageInputErrorBorderWidth"] + ");background: " + $params["pageInputErrorBG"] + ";border: " + $params["pageInputErrorBorderWidth"] + " solid " + $params["pageInputErrorBorderColor"] + "}\n@media all and (-ms-high-contrast: none), (-ms-high-contrast: active){\n  " + $id + ".Pagination1096990051--root .Pagination1468839169--totalPages{max-width: 6ch;min-width: 6ch}\n}\n";
};
...
var _Pagination = __webpack_require__(/*! ./Pagination */ 561);

var _PaginationSt = __webpack_require__(/*! ./Pagination.st.css */ 303);
...
var _Pagination = __webpack_require__(/*! wix-ui-core/Pagination */ 562);

var _paginationIcons = __webpack_require__(/*! ./paginationIcons */ 567);
...
module.exports = __webpack_require__(/*! ./dist/src/components/Pagination */ 563);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Pagination_1 = __webpack_require__(/*! ./Pagination */ 302);
...
var tslib_1 = __webpack_require__(/*! tslib */ 17);
var React = __webpack_require__(/*! react */ 0);
var page_strip_layout_1 = __webpack_require__(/*! ./page-strip-layout */ 565);
var Pagination_st_css_1 = __webpack_require__(/*! ./Pagination.st.css */ 26);
